import { writeBatch, doc, deleteDoc, getDocs, collection, query, Timestamp } from 'firebase/firestore';
...
export const seedDemoData = async () => {
  try {
    ...
    incidents.forEach(incident => {
      ...
      batch.set(incidentRef, incidentData, { merge: true });
    });
